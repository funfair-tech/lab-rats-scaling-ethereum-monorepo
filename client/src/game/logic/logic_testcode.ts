    ...
    public KeyPressed(keyCode: number): void {
        ...
        if(keyCode === 81) { //'q' place bet for user 1
            ...
            if(response === Logic_BetResponse.BETSUBMITTED) {
                ...
                console.log('Logic_TestCode.Keypressed fake player 2 bet higher failed with Logic_BetResponse value ' + response);
            }    
        }
        ...
        if(keyCode === 87) { //'w' place bet for user 1
            ...
            if(response === Logic_BetResponse.BETSUBMITTED) {
                ...
                console.log('Logic_TestCode.Keypressed fake player 3 bet lower failed with Logic_BetResponse value ' + response);
            }
        ...
        if(keyCode === 82) { //'r' place bet for user 1
            ...
            if(response === Logic_BetResponse.BETSUBMITTED) {
                ...
                console.log('Logic_TestCode.Keypressed fake player 4 bet lower failed with Logic_BetResponse value ' + response);
            }
        ...
        if(keyCode === 84) { //'t' place bet for user 1
            ...
            if(response === Logic_BetResponse.BETSUBMITTED) {
                ...
                console.log('Logic_TestCode.Keypressed fake player 5 bet lower failed with Logic_BetResponse value ' + response);
            }
        ...
        if(keyCode === 89) { //'y' place bet for user 1
            ...
            if(response === Logic_BetResponse.BETSUBMITTED) {
                ...
                console.log('Logic_TestCode.Keypressed fake player 6 bet higher failed with Logic_BetResponse value ' + response);
            }
