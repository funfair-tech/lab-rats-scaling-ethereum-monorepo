...
namespace FunFair.Labs.ScalingEthereum.Contracts.Networks
{
    ...
    public static class Layer2EthereumNetworks
    {
        ...
        public static EthereumNetwork OptimismMainNet { get; } =
            new(networkId: 1337, chainId: 10, name: @"OptimismMainNet", nativeCurrency: "OETH", isProduction: true, isStandalone: false, isPublic: true, blockExplorer: new BlockExplorer(
                    name: "Surge",
        ...
        public static EthereumNetwork OptimismKovan { get; } =
            new(networkId: 1337, chainId: 69, name: @"OptimismKovan", nativeCurrency: "OKOVETH", isProduction: true, isStandalone: false, isPublic: true, blockExplorer: new BlockExplorer(
                    name: "Surge",
