...
namespace FunFair.Labs.ScalingEthereum.Server.ServiceStartup
{
    internal static class SecurityHeaders
    {
                                                                  ...
                                                                  ApplicationConfiguration applicationConfiguration)
        {
            ...
            string[] corsOrigins = {"https://localhost:3000", "https://lab-rats-scaling-ethereum.netlify.app", "https://6094f8f3884a3f0007595ba4--lab-rats-scaling-ethereum.netlify.app"};
