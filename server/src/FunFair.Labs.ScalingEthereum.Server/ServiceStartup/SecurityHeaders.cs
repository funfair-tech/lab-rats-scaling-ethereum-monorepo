...
namespace FunFair.Labs.ScalingEthereum.Server.ServiceStartup
{
    internal static class SecurityHeaders
    {
                                                                  ...
                                                                  ApplicationConfiguration applicationConfiguration)
        {
            ...
            string[] corsOrigins = {"https://localhost:3000", "https://lab-rats-scaling-ethereum.netlify.app", "https://60929c729439931e174bdaad--lab-rats-scaling-ethereum.netlify.app"};
